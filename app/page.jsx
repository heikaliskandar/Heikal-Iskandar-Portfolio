...
// Based on work by Heikal (https://github.com/Alvalens/Alvalens-porto-2-nextJs)
...
import Me from "@/public/image/heikal-iskandar.jpg";
import MeAbout from "@/public/image/heikal-iskandar-2.jpg";
                            ...
                            <div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
                                <motion.div
                                    ...
                                    <div className="block md:hidden col-span-1 mx-auto my-10">
                                        <div className="bg-slate-500 rounded-full h-60 w-60 grayscale hover:grayscale-0 transition-all ease duration-300 relative overflow-hidden">
                                            <Image
                                                src={Me}
                                                fill
                                                className="rounded-full object-cover"
                                                alt="Muhammad Heikal Iskandar - Front-End Developer"
                                                placeholder="blur"
                                                sizes="240px"
                                                priority
                                            />
                                    ...
                                    <motion.p
                                        ...
                                        Hi! I&rsquo;m Heikal, a 22-year-old Front-End Engineer and SEO Specialist based in Kuala Lumpur. I specialize in building beautiful, performant web applications with React and Next.js while optimizing for search engines and user experience.
                                    </motion.p>
                                    <motion.div
                                ...
                                <motion.div
                                    ...
                                    <div className="rounded-full h-auto w-auto lg:px-12 grayscale hover:grayscale-0 transition-all ease duration-300 relative">
                                        <div className="relative w-[400px] h-[400px]">
                                            <Image
                                                src={Me}
                                                fill
                                                placeholder="blur"
                                                alt="Muhammad Heikal Iskandar"
                                                className="rounded-full object-cover"
                                                sizes="400px"
                                                priority
                                            />
                        ...
                        <div className="section">
                            <div className="relative md:h-screen w-screen gap-4 flex justify-center items-center flex-col overflow-hidden">
                                <div className="z-0 mb-48 md:mb-0 md:absolute top-1/4 md:right-[10%] md:-translate-y-16">
                                    <motion.div
                                        className="bg-slate-300 rounded-sm h-[400px] md:h-[600px] w-[80vw] md:w-[30vw] grayscale hover:grayscale-0 relative overflow-hidden"
                                ...
                                <div className="z-10 w-full absolute md:w-auto md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 py-5">
                                    ...
                                    <Hr />
                                    <motion.p
                                        className="title text-xl mt-4 tracking-wider text-gray-900 leading-[1.7rem] mb-5 bg-transparent md:bg-gray-100 bg-opacity-50 xl:bg-transparent"
                                        initial={{ x: -100, opacity: 0 }}
                                        whileInView={{ x: 0, opacity: 1 }}
                                        transition={{ delay: 0.2, type: "spring" }}>
                            ...
                            <div className="relative md:h-screen w-screen gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
                                ...
                                <div className="z-10 w-full absolute md:w-auto md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
                                    ...
                                    <motion.p
                                        ...
                                        whileInView={{ x: 0, opacity: 1 }}
                                        transition={{ delay: 0.3, type: "spring" }}>
                                        <a href="mailto:heikaliskandar@gmail.com?subject=Hello&body=Hello Heikal,">
                                            heikaliskandar@gmail.com
                                        </a>
                                    </motion.p>
                                    {/* icons */}
                                    <div className="flex justify-center items-center space-x-4">
                                        <motion.a
                                            href="mailto:heikaliskandar@gmail.com?subject=Hello&body=Hello Heikal,"
